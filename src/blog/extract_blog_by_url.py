...
def parse_post(post_element: WebElement) -> dict[str, str] | None:
    try:
...
def get_posts(driver_: WebDriver, timeout: int = 1, selector: str = "div.card__reUkU") -> list[dict[str, str | None]]:
    try:
