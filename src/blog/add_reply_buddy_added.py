...
from common.webs import setup_firefox_profile_driver, parse_buddy_by_added, move_to_buddy_added_scroll, try_click_element, process_reply_and_is_limited
...
if __name__ == '__main__':
    ...
    try:
        move_to_buddy_added_scroll(driver, configuration, range_=5)
